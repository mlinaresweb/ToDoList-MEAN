...
export class TodolistService {
  ...
  private url_get = 'http://localhost:53514/api/get_items';
  private url_post = 'http://localhost:53514/api/add_item';
  private url_delete = 'http://localhost:53514/api/delete_item';
  private url_put = 'http://localhost:53514/api/edit_item';
